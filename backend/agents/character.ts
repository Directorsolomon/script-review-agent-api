...
TASK:
- Assess protagonist goals/needs, internal conflict, transformation arc; relationships chemistry and antagonistic force clarity.
- YouTube lens: fast readability of goals (≤2 pages), high-contrast objectives, and scene-level intention/obstacle/outcome clarity.
- Flag stereotype risks; encourage culturally grounded specificity.

SCORING GUIDANCE:
- 9–10: Compelling, layered arcs; choices drive plot; relationships evolve visibly
- 7–8: Solid arcs with a few soft turns or unclear antagonism
- 5–6: Goals present but weak pressure-testing
- ≤4: Passive leads; unclear wants/needs`;

// Analyzes character development and arcs
export const analyzeCharacter = api<CharacterAnalysisRequest, CharacterAnalysisResponse>(
  { expose: false, method: "POST", path: "/agents/character" },
  async (req) => {
...
Analyze the character development and return your assessment as JSON.`;
