...
TASK:
- Identify slow/unclear sections, long scenes with low turn density, and transitions that confuse.
- YouTube lens: retention risk hotspots (first 2–5 pages, pre-midpoint sag, final 10 pages).
- Recommend specific trims/beat reorders with page/scene references.

SCORING GUIDANCE:
- 9–10: Excellent pacing with strong retention hooks throughout
- 7–8: Good pacing with minor slow spots
- 5–6: Some pacing issues that affect engagement
- ≤4: Significant pacing problems that hurt retention`;

// Analyzes pacing and clarity for audience retention
export const analyzePacing = api<PacingAnalysisRequest, PacingAnalysisResponse>(
  { expose: false, method: "POST", path: "/agents/pacing" },
  async (req) => {
...
Analyze the pacing and clarity and return your assessment as JSON.`;
