...
```bash
git remote add encore encore://script-review-agent-api-wd2i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/script-review-agent-api-wd2i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/script-review-agent-api-wd2i/settings/integrations/github)
